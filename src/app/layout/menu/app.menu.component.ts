            ...
            this.model = [
                ...
                items: [
                    ...
                    items: [
                        ...
                        items: [
                            {
                            label: this.translate.instant('SUBMENU_1_1_1'),
                            icon: 'pi pi-fw pi-bookmark',
                            },
                            {
                            label: this.translate.instant('SUBMENU_1_1_2'),
                            icon: 'pi pi-fw pi-bookmark',
                            },
                            {
                            label: this.translate.instant('SUBMENU_1_1_3'),
                            icon: 'pi pi-fw pi-bookmark',
                            },
                        ],
                        },
                        ...
                        items: [
                            {
                            label: this.translate.instant('SUBMENU_1_2_1'),
                            icon: 'pi pi-fw pi-bookmark',
                            },
                        ],
                        },
