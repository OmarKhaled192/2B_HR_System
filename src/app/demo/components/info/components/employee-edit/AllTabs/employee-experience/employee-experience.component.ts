...
export class EmployeeExperienceComponent {
    ...
    ngOnInit() {
        ...
        Globals.getMainLangChanges().subscribe((mainLang) => {
            ...
            this.employeeExperienceService.setCulture(mainLang);

            // update endpoint
            this.employeeExperienceService.setEndPoint(this.endPoint);
    ...
    editProduct(rowData: any) {
        ...
        this.employeeExperienceService.GetById(rowData.id).subscribe({
            next: (res) => {
    ...
    confirmDelete(id: number) {
        ...
        this.employeeExperienceService.DeleteRange([id]).subscribe({
            next: () => {
                // close dialog
    ...
    loadData(
        ...
        this.employeeExperienceService.GetPage(filteredData).subscribe({
            next: (res) => {
                console.log(res);
    ...
    confirmDeleteSelected() {
        ...
        this.employeeExperienceService.DeleteRange(selectedIds).subscribe({
            next: (res) => {
