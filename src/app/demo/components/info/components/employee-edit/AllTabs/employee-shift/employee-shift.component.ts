...
export class EmployeeShiftComponent {
    ...
    ngOnInit() {
        ...
        Globals.getMainLangChanges().subscribe((mainLang) => {
            ...
            this.employeeShiftService.setCulture(mainLang);

            // update endpoint
            this.employeeShiftService.setEndPoint(this.endPoint);
    ...
    getDropDowns() {
        this.employeeShiftService.getDropdownField('Employee').subscribe({
            next: (res) => {
        ...
        this.employeeShiftService.getManagerDropdown().subscribe({
            next: (res) => {
                console.log(res.data);
        ...
        this.employeeShiftService.getDropdownField('Location').subscribe({
            next: (res) => {
                console.log(res.data);
        ...
        this.employeeShiftService.getDropdownField('Shift').subscribe({
            next: (res) => {
                console.log(res.data);
                this.dropdownItemsShifts = res.data;
            },
            error: (err) => {
                console.log(err);
            },
    ...
    loadData(
        ...
        this.employeeShiftService.GetPage(formData).subscribe({
            next: (res) => {
                console.log(res);
